    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTimeOffset(new DateTime(2025, 9, 25, 10, 37, 54, 998, DateTimeKind.Unspecified).AddTicks(20), new TimeSpan(0, 0, 0, 0, 0)), "Kerem.Karacay@tasksync.test", null, null, "", "Kerem Karacay" },
                    { 2, 0, new DateTimeOffset(new DateTime(2025, 9, 25, 10, 37, 54, 998, DateTimeKind.Unspecified).AddTicks(50), new TimeSpan(0, 0, 0, 0, 0)), "Deniz.Aslansu@tasksync.test", null, null, "", "Deniz Aslansu" },
                    { 3, 0, new DateTimeOffset(new DateTime(2025, 9, 25, 10, 37, 54, 998, DateTimeKind.Unspecified).AddTicks(60), new TimeSpan(0, 0, 0, 0, 0)), "Ali.Balci@tasksync.test", null, null, "", "Ali Balcı" },
                    { 4, 0, new DateTimeOffset(new DateTime(2025, 9, 25, 10, 37, 54, 998, DateTimeKind.Unspecified).AddTicks(80), new TimeSpan(0, 0, 0, 0, 0)), "Sven.Imker@tasksync.test", null, null, "", "Sven Imker" },
                    { 5, 0, new DateTimeOffset(new DateTime(2025, 9, 25, 10, 37, 54, 998, DateTimeKind.Unspecified).AddTicks(90), new TimeSpan(0, 0, 0, 0, 0)), "Mina.Koch@tasksync.test", null, null, "", "Mina Koch" }
                });
